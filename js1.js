...
function matchCards(img1, img2){ 
    ...
    if(img1 === img2){ // if two cards img matched
        ...
        if(matchedCard == 6){ // if matched value is 8 that means user has matched all the cards
...
function shuffleCard(){
    ...
    let arr = [1, 2, 3, 4, 5, 6, 1, 2,3 ,4,5,6]; //creating array of 16 items and each item is repeated twice
